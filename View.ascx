...
<hr class="dividers_2" />
<div class="row">
<div class="col-md-3"><b>Herindexeer ALLE documenten</b> <a href="#" class="tooltips" data-toggle="tooltip" title="Herindexeer alle documenten."><span class="glyphicons glyph-circle-question-mark">&nbsp;</span></a></div>
<div class="col-md-8">
...
<div class="col-md-5">
	...
	<div class="col-md-4">
    <div class="form-group">
        <br/><asp:Button ID="bIndexFolder" runat="server" Text="Reindex folder" OnClick="bIndexFolder_Click" CssClass="btn btn-primary" />
    </div>
		</div></div>
		<hr class="dividers_2" />
<div class="row">
